...
現在は**P0互換性PoCとMVP実装基盤**フェーズです。最初の基盤として、実 App Server に依存しないBackendのBridge契約とworkspace Schedulerを実装しています。Web UI、FastAPI配信、SQLite、実 App Server stdio adapterは未実装です。
